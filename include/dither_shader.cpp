...
{
    construct();
    queue_callable_on_render_thread(callable_mp(this, &DitherShader::init_compute).bind("dither.glsl"));
}
...
void DitherShader::_render_callback(int32_t p_effect_callback_type, RenderData *p_render_data)
{
